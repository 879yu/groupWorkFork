					...
					<div id="login-box" class="col-md-12">
						<form id="login-form" class="form" action="" method="post">
							...
							<div class="form-group">
								...
								<input type="text" name="user_id" id="username" class="form-control" pattern="^[0-9A-Za-z]+$" placeholder="従業員IDを入力してください" required>
							</div>
							<div class="form-group">
								<label for="password">パスワード:</label><br>
								<input type="password" name="password" id="password" class="form-control" placeholder="4桁のパスワードを入力してください" required>
							</div>
							<div class="form-group">
								<input type="submit" name="submit" class="btn btn-outline-dark btn-md text-center" value="ログイン">
							</div>
						</div>
						</form>
				</div>
