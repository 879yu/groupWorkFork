				...
				<div class="sidebar-sticky">
					<ul class="nav flex-column">
						...
						<li class="nav-item"><a class="nav-link active"
							href="/groupwork/BookLendServlet"> <span data-feather="home"></span>
								<i class="fas fa-list"></i> ランキング
						</a></li>

						<!-- 貸出中の書籍を表示 -->
						<li class="nav-item"><a class="nav-link"
							href="/groupwork/LendServlet"> <span data-feather="file"></span>
								<i class="fas fa-history"></i> 貸出履歴
						</a></li>
